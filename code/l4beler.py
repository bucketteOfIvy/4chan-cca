...
if __name__ == '__main__':
    ...
    week_num = limited_input('Which week\'s data?', 
                                is_valid_response=lambda x: True if str(x) in ['1', '2', '3'] else False,
                                condition = 'one of 1, 2, or 3')
    
    # Read and subset
    posts = pd.read_csv(f'../data/lgbt_week_{week_num}.csv')
